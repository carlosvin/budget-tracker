...
export const PrivacyPolicy: React.FC<HeaderNotifierProps&RouterProps> = (props) => {
    ...
    <div style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", padding: "1em" }}>
       <p>
        ...
        Budget Tracker unless otherwise defined in this Privacy
        Policy.
        ...
        used by the app
                    </p> <ul><li><a href="https://firebase.google.com/policies/analytics" >Firebase Analytics</a></li></ul></div> <p><strong>Log Data</strong></p> <p>
